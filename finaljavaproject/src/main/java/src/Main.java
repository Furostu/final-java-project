...
public class Main extends JFrame {
    ...
    public Main() {
        ...
        lblNewLabel.setIcon(new ImageIcon(Main.class.getResource("/src.images/last.png")));
        ...
        lblNewLabel_1.setIcon(new ImageIcon(Main.class.getResource("/src.images/Vector.png")));
        ...
        lblNewLabel_2.setIcon(new ImageIcon(Main.class.getResource("/src.images/Proceed.png")));
